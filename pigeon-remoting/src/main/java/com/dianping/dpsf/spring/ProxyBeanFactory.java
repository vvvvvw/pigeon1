...
public class ProxyBeanFactory implements FactoryBean {
	 ...
	 * 使慢的提供者收到更少请求，因为越慢的提供者的调用前后计数差会越大。 //?为什么代码里好像是发给capacity小的服务器
	 * 
	...
	public void init() throws Exception {
		...
		//classLoader为null，表示使用的是本线程的上下文类加载器
	...
	//依次从loadBalanceObj、loadBalanceClass、loadBalance中选择出一个来实现负载平衡，优先级从前往后
	//并注册到本地缓存
